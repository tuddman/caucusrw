...
{{
var G__13555 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13555;
continue;
}
} else
...
{var pred__13559 = cljs.core._EQ_;var expr__13560 = limit;if(cljs.core.truth_(pred__13559.call(null,1,expr__13560)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13559.call(null,2,expr__13560)))
...
var G__13562 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13563 = (limit__$1 - 1);
var G__13564 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13562;
limit__$1 = G__13563;
parts = G__13564;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13566 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13566))
{var replacement_13567 = temp__4090__auto___13566;buffer.append([cljs.core.str(replacement_13567)].join(''));
} else
{buffer.append(ch);
}
{
var G__13568 = (index + 1);
index = G__13568;
continue;
}
}
