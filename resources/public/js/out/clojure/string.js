...
{{
var G__10741 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10741;
continue;
}
} else
...
{var pred__10745 = cljs.core._EQ_;var expr__10746 = limit;if(cljs.core.truth_(pred__10745.call(null,1,expr__10746)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10745.call(null,2,expr__10746)))
...
var G__10748 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10749 = (limit__$1 - 1);
var G__10750 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10748;
limit__$1 = G__10749;
parts = G__10750;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10752 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10752))
{var replacement_10753 = temp__4090__auto___10752;buffer.append([cljs.core.str(replacement_10753)].join(''));
} else
{buffer.append(ch);
}
{
var G__10754 = (index + 1);
index = G__10754;
continue;
}
}
