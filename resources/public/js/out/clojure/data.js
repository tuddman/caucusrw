...
{return cljs.core.reduce.call(null,(function (result,p__13513){var vec__13514 = p__13513;var k = cljs.core.nth.call(null,vec__13514,0,null);var v = cljs.core.nth.call(null,vec__13514,1,null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__13516 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__13516,0,null);var b_STAR_ = cljs.core.nth.call(null,vec__13516,1,null);var ab = cljs.core.nth.call(null,vec__13516,2,null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj13518 = {};return obj13518;
})();
clojure.data.equality_partition = (function equality_partition(x){if((function (){var and__3431__auto__ = x;if(and__3431__auto__)
...
{var x__4070__auto__ = (((x == null))?null:x);return (function (){var or__3443__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4070__auto__)]);if(or__3443__auto__)
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = (clojure.data.equality_partition["_"]);if(or__3443__auto____$1)
...
clojure.data.Diff = (function (){var obj13520 = {};return obj13520;
})();
clojure.data.diff_similar = (function diff_similar(a,b){if((function (){var and__3431__auto__ = a;if(and__3431__auto__)
...
{var x__4070__auto__ = (((a == null))?null:a);return (function (){var or__3443__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4070__auto__)]);if(or__3443__auto__)
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = (clojure.data.diff_similar["_"]);if(or__3443__auto____$1)
{return or__3443__auto____$1;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__13521 = x;if(G__13521)
{var bit__4093__auto__ = (G__13521.cljs$lang$protocol_mask$partition0$ & 1024);if((bit__4093__auto__) || (G__13521.cljs$core$IMap$))
{return true;
} else
{if((!G__13521.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__13521);
} else
{return false;
}
}
...
{if((function (){var G__13522 = x;if(G__13522)
{var bit__4093__auto__ = (G__13522.cljs$lang$protocol_mask$partition0$ & 4096);if((bit__4093__auto__) || (G__13522.cljs$core$ISet$))
{return true;
} else
{if((!G__13522.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__13522);
} else
{return false;
}
}
...
{if((function (){var G__13523 = x;if(G__13523)
{var bit__4093__auto__ = (G__13523.cljs$lang$protocol_mask$partition0$ & 16777216);if((bit__4093__auto__) || (G__13523.cljs$core$ISequential$))
{return true;
} else
{if((!G__13523.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__13523);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__13524 = clojure.data.equality_partition.call(null,a);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"map","map",1014012110),G__13524))
{return clojure.data.diff_associative;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"sequential","sequential",849892465),G__13524))
{return clojure.data.diff_sequential;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"set","set",1014018004),G__13524))
{return clojure.data.diff_set;
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"atom","atom",1016908995),G__13524))
