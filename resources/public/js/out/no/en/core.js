...
var url_encode__delegate = function (s,p__10770){var vec__10772 = p__10770;var encoding = cljs.core.nth.call(null,vec__10772,0,null);if(cljs.core.truth_(s))
...
return url_encode__delegate.call(this,s,p__10770);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__10773){
var s = cljs.core.first(arglist__10773);
var p__10770 = cljs.core.rest(arglist__10773);
return url_encode__delegate(s,p__10770);
});
...
var url_decode__delegate = function (s,p__10774){var vec__10776 = p__10774;var encoding = cljs.core.nth.call(null,vec__10776,0,null);if(cljs.core.truth_(s))
...
return url_decode__delegate.call(this,s,p__10774);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__10777){
var s = cljs.core.first(arglist__10777);
var p__10774 = cljs.core.rest(arglist__10777);
return url_decode__delegate(s,p__10774);
});
...
{var G__10780 = clojure.string.upper_case.call(null,unit);if(new cljs.core.Keyword(null,"else","else",1017020587))
{var G__10781 = unit;if(cljs.core._EQ_.call(null,"B",G__10781))
{return (number * 1000000000);
} else
{if(cljs.core._EQ_.call(null,"M",G__10781))
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__10782_SHARP_){return parseInt(p1__10782_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__10783_SHARP_){return parseInt(p1__10783_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__10784_SHARP_){return parseFloat(p1__10784_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__10785_SHARP_){return parseFloat(p1__10785_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){return clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__10787_SHARP_){return clojure.string.join.call(null,"=",p1__10787_SHARP_);
}),cljs.core.map.call(null,(function (p1__10786_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__10786_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__10786_SHARP_))],null));
}),cljs.core.seq.call(null,m))));
});
/**
* Format the Ring map as an url.
*/
no.en.core.format_url = (function format_url(m){return [cljs.core.str(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",4400883991).cljs$core$IFn$_invoke$arity$1(m))),cljs.core.str("://"),cljs.core.str((function (){var map__10789 = m;var map__10789__$1 = ((cljs.core.seq_QMARK_.call(null,map__10789))?cljs.core.apply.call(null,cljs.core.hash_map,map__10789):map__10789);var password = cljs.core.get.call(null,map__10789__$1,new cljs.core.Keyword(null,"password","password",2230889997));var user = cljs.core.get.call(null,map__10789__$1,new cljs.core.Keyword(null,"user","user",1017503549));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__10792_SHARP_){return (new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__10792_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__10792_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__10791_SHARP_){return cljs.core._EQ_.call(null,2,cljs.core.count.call(null,p1__10791_SHARP_));
}),cljs.core.map.call(null,(function (p1__10790_SHARP_){return clojure.string.split.call(null,p1__10790_SHARP_,/=/);
